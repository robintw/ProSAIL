...
def soilref(psoil, Rsoil1, Rsoil2): # Linear soil wetness mixing model. 
...
# spectra, Remote Sennp.sing of Environment, 34:75-91.
# ********************************************************************************
# version 5.02 (25 July 2011)
# ********************************************************************************
def prospect_5B(N,Cab,Car,Cbrown,Cw,Cm,spectra):
    ...
    theta1=90.
    t1= tav_abs(theta1,refractive)
    theta2=40.
    t2= tav_abs(theta2,refractive)
    x1=1-t1
...
def calcLidf(TypeLidf=1,LIDFa=-0.35,LIDFb=-0.15):
...
def calc_LIDF_ellipsoidal(na,alpha):
#...............................................................................
#     Call leaf angle distribution fonction                  
#...............................................................................
    freq= campbell(na,alpha)
    return freq
...
#	this module must also be declared in the calling routine.
    ...
    for i in range(na):
        chi_s,chi_o,frho,ftau= volscatt(tts,tto,psi,ttl[i])
...
def writeoutput(l, resh, resv, outfile):
    if len(outfile)==0:
...
#****************************************************
def writeconfig(paramnames, paramlist, outname):
...
def canref(rsot, rdot, rsdt, rddt, Es, Ed, tts):
